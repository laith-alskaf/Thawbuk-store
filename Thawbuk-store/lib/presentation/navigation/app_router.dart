...
// import '../pages/admin/store_profile_page.dart';
...
//           builder: (context, state) => const AdminLayout(initialIndex: 0),
//         ),
//         GoRoute(
//           path: '/admin/products',
//           name: 'admin-products',
//           builder: (context, state) => const AdminLayout(initialIndex: 1),
//         ),
//         GoRoute(
//           path: '/admin/add-product',
//           name: 'admin-add-product',
//           builder: (context, state) => const AdminLayout(initialIndex: 2),
//         ),
//         GoRoute(
